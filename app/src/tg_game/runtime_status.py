...
RUNTIME_CORE_FILES = [
    ...
    "tg_game/storage.py",
    "tg_game/web/admin_battle_schedule.py",
    "tg_game/features/artifact/biz_artifact_touch_auto.py",
    "tg_game/features/artifact/biz_artifact_nurture.py",
    "tg_game/features/artifact/biz_artifact_trial.py",
    "tg_game/web/biz_artifact_view_model.py",
    "tg_game/features/beast_merge/biz_beast_merge_daily_auto.py",
    "tg_game/features/beast_merge/biz_beast_merge_miniapp.py",
    "tg_game/features/beast_merge/biz_beast_merge_solver.py",
    "tg_game/features/beast_merge/biz_beast_merge_state.py",
    "tg_game/features/battle/biz_battle_schedule.py",
    ...
    "tg_game/features/pagoda/biz_pagoda_miniapp.py",
    "tg_game/features/pagoda/biz_pagoda_state.py",
